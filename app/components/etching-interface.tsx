...
export function EtchingInterface() {
  ...
  if (success) {
    return (
      <Card className="max-w-2xl mx-auto bg-black/40 backdrop-blur-sm border-green-500/30">
        <CardContent className="p-8 text-center">
          <CheckCircle className="h-16 w-16 text-green-400 mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-green-400 mb-2">🎉 Rune Etched Successfully!</h2>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-400">Bitcoin Tx</p>
              <Button
                variant="ghost"
                size="sm"
                onClick={() => window.open(`https://mempool.space/testnet/tx/${txHashes.bitcoin}`, "_blank")}
                className="text-xs text-blue-400 font-mono hover:text-blue-300"
              >
            ...
            <div className="bg-gray-800/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-400">Starknet Tx</p>
              <Button
                variant="ghost"
                size="sm"
                onClick={() => window.open(`https://sepolia.starkscan.co/tx/${txHashes.starknet}`, "_blank")}
                className="text-xs text-blue-400 font-mono hover:text-blue-300"
              >
          ...
          <Button onClick={() => setSuccess(false)} className="bg-orange-500 hover:bg-orange-600">
            Etch Another Rune
          </Button>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="premineAmount" className="text-gray-300">
                  Premine Amount
                </Label>
                <Input
                  id="premineAmount"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  disabled={!isConnected}
                />
                <Label htmlFor="enableBridge" className="text-gray-300">
              ...
              {isConnected && address && (
                <div className="p-3 bg-gray-800/30 rounded-lg">
                  ...
                  <p className="text-xs text-green-400 font-mono">{address}</p>
                </div>
              )}
            </div>
          </div>
          ...
          {isEtching && (
            <div className="space-y-4 p-4 bg-gray-800/30 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">{etchingStep}</span>
              </div>
          ...
          <Button
            onClick={handleEtch}
            disabled={isEtching || !form.ticker || !form.totalSupply || !isConnected}
